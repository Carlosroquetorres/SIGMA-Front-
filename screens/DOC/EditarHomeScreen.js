...
const EditarHomeScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView scrollEnabled={false} style={styles.back}>
      ...
      <Text style={styles.text2}>EDITAR DOCUMENTO</Text>
      </View> 
     ...
     <TouchableOpacity onPress={() => navigation.navigate('BuscDoc')} style={styles.button}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('EditHomeDoc')} style={styles.button}>
        ...
        <View style={styles.buttonContainer3}>
            <Button style={styles.button} onPress={() => navigation.navigate('AgregarDoc')} title="Agregar Documento" color="#9F1B3B"/>
            </View>
       ...
       <View style={styles.table}>
          ...
          <View style={styles.row1}>
            ...
            <Text style={styles.cell1}>EDITAR</Text>
          </View>
          {/* Resto de las filas */}
          <View style={styles.row}>
            ...
            <Text style={styles.cell}>--</Text>
            <Text style={styles.cell}>--</Text>
            <Text style={styles.cell}> <View style={styles.cell3}><Button onPress={() => navigation.navigate('EditarDoc')} style={styles.button} title="Editar" color="#9F1B3B"/></View></Text>
          </View>
...
export default EditarHomeScreen;