  ...
  return (
    <ScrollView scrollEnabled={false} style={styles.back}>
     ...
     <Animatable.View animation="bounceInLeft" style={styles.container5}>
        ...
        <Image style={styles.imag} source={require('../img/Testudiante.png')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('TramitesCategory')}>
        <Image style={styles.imag} source={require('../img/Tdocente.png')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('TramitesCategory')}>
        <Image style={styles.imag} source={require('../img/Tadmin.png')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('TramitesCategory')}>
        <Image style={styles.imag} source={require('../img/Textra.png')} />
        </TouchableOpacity>
        </Animatable.View>
