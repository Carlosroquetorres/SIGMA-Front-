    ...
    <ScrollView scrollEnabled={false} style={styles.back}>
     ...
     <TouchableOpacity onPress={() => navigation.navigate('Quejas')}>
      ...
      <Text style={styles.b3}>ADMINISTRATIVO</Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('OpAd')}>
        <Image style={styles.imag} source={require('./img/image15.png')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('AdminSubAca')}>
        <Image style={styles.imag} source={require('./img/image23.png')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('AdminSerAdmin')}>
        <Image style={styles.imag} source={require('./img/image24.png')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('AdminPlanVinc')}>
        <Image style={styles.imag} source={require('./img/image25.png')} />
        </TouchableOpacity>
        </Animatable.View>
